...
<body>
    <form id="form1" runat="server">
        ...
        <header class="header black-bg">
            ...
            <!--nombre sistema-->
            <a href="index.aspx" class="logo"><b>SGM<span>EYM</span></b></a>
            <!--nombre sistema fin-->
            <div class="nav notify-row" id="top_menu">
                <ul class="nav top-menu">
                     <!-- notificaciones-->
                    <li id="header_notification_bar" class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.aspx#">
                        ...
                        <ul class="dropdown-menu extended notification">
                            ...
                            <li>
                                <a href="index.aspx#">See all notifications</a>
                            </li>
                        </ul>
                    </li>
                    <!-- notificaciones fin-->
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                <ul class="sidebar-menu" id="nav-accordion">
                    <!-- usuario-->
                    <p class="centered"><a href="profile.html"><img src="img/usuario.jpg" class="img-circle" width="80"></a></p>
